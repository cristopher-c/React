...
import { getInitialState, scrambledWordState } from './scrambleWord.reducer';


export const ScrambleWords = () => {

  const [state, dispatch] = useReducer(scrambledWordState,getInitialState());
  ...
  const handlePlayAgain = () => {
    dispatch({
      type: 'PLAY_AGAIN', payload: getInitialState()
    });
  };
